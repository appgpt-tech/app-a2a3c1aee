  ...
  resources: {
    ...
    Customers: {
      ...
      fields: {
        ...
        weight: 'Weight (gr)',
        height: 'Height (gr)',
        healthConditions: 'Health Conditions (gr)',
        goals: 'Goals (gr)',
    ...
    Workouts: {
      ...
      fields: {
        ...
        relatedCustomer: 'Related Customer (gr)',
        type: 'Type (gr)',
        duration: 'Duration (gr)',
        intensity: 'Intensity (gr)',
        caloriesBurned: 'Calories Burned (gr)',
        date: 'Date (gr)',
        id: 'id',
      },
    },
    Nutrition: {
      ...
      fields: {
        description: 'Description (gr)',
        relatedCustomer: 'Related Customer (gr)',
        foodItem: 'Food Item (gr)',
        quantity: 'Quantity (gr)',
        calories: 'Calories (gr)',
        macronutrients: 'Macronutrients (gr)',
        date: 'Date (gr)',
        id: 'id',
      },
    },
    HealthMetrics: {
      name: 'Health Metrics (gr)',
      fields: {
        description: 'Description (gr)',
        relatedCustomer: 'Related Customer (gr)',
        type: 'Type (gr)',
    ...
    Notifications: {
      name: 'Notifications (gr)',
      fields: {
        description: 'Description (gr)',
        relatedCustomer: 'Related Customer (gr)',
        type: 'Type (gr)',
        message: 'Message (gr)',
        dateScheduled: 'Date Scheduled (gr)',
        status: 'Status (gr)',
        id: 'id',
      },
    },
    SupportTickets: {
      ...
      fields: {
        description: 'Description (gr)',
        relatedTicket: 'Related Ticket (gr)',
        relatedUser: 'Related User (gr)',
        relatedCustomer: 'Related Customer (gr)',
        status: 'Status (gr)',
